...
// Add loading animation to images on page load
document.addEventListener('DOMContentLoaded', () => {
  const allImages = document.querySelectorAll('.movie-list-item-img, .featured-title');
  ...
  // Stagger animation for movie items
...
function navigateToAnimeDetails(animeTitle) {
...
// Add click event to movie items for navigation to details page
...
movieListItems.forEach(item => {
  item.addEventListener('click', (e) => {
    ...
    if (e.target.classList.contains('movie-list-item-button') || 
        e.target.closest('.movie-list-item-button')) {
      return;
    }
